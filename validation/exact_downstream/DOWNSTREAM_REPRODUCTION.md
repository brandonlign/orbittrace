...
I used the analysis source from commit `39972b5fe0cf4d47092d3caa2b3ced12bedb065e` to repeat the main GMN analyses after event selection. The regenerated results matched the saved evidence.
...
External-catalogue checks are recorded separately because they use different source files and assumptions.
