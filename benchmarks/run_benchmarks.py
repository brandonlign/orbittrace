"""Validate and summarize the frozen fair comparator results."""
...
def main() -> int:
    ...
    result = json.loads(Path("benchmarks/frozen_benchmark_results.json").read_text())
    ...
    summary = {
        ...
        "scope": "ACRF, Sugar, catalogue-HDBSCAN, clean-room D-criterion, and three known-shower controls",
    }
