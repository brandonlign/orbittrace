...
class V2Config:
    ...
    The recurrence score is exposure-normalized per observing year and then
    evaluated at a lower-tail quantile.  The lower-tail rule keeps one weak
    year from dominating the ranking while the support gate still prevents a
    one-year cluster from being called recurrent.
    """
